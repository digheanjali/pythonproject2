...
#setC.intersection(setD) 22,33     # common
#setC.difference(setD) 11
#setC.union(setD) 11,22,33,44      # all elemnt print in one time
...
setC = {11,22,33}
setD = {22,33,44}
setJ = setC.symmetric_difference(setD)             #only print different value
print(setJ)
...
setC = {112,222}
setD = {11,22,33,44}
print(setC.isdisjoint(setD))     # Return True if two sets have a null intersection(common)
